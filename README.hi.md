...
-   स्व-तैनात एलएलएम के साथ पूरी तरह से संगत, इसे आरडब्ल्यूकेवी-रनर या लोकलएआई के साथ उपयोग करने की अनुशंसा की जाती है
...
-   [एक एपीआई](https://github.com/songquanpeng/one-api): एक वन-स्टॉप बड़ा मॉडल कोटा प्रबंधन प्लेटफ़ॉर्म जो बाज़ार में सभी मुख्यधारा के बड़े भाषा मॉडल का समर्थन करता है।
