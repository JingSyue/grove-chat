import { trimTopic, getMessageTextContent, readFileContent } from "../utils";
  ...
  (set, _get) => {
    ...
    const methods = {
      ...
      async onUserInput(
        ...
        console.log("store chat", getClientApi(modelConfig.providerName));

        const api: ClientApi = getClientApi(modelConfig.providerName);
        console.log("store chat", sendMessages);
        // make request
        api.llm.chat({
